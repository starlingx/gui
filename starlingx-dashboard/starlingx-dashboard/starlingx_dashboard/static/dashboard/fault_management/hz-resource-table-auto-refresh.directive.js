...
(function() {
  ...
  angular
    ...
    .directive('hzResourceTableAutoReload', directive);
   ...
   * @ngdoc directive
   * @scope
   * @name hzResourceTableAutoReload
   * @description
  ...
  function directive(basePath) {
    ...
    var directive = {
      ...
      controller: "horizon.framework.widgets.table.AutoResourceTableController as ctrl"
    };
